...
The `dir-staging` maintainers take all security issues in the project
seriously. Thank you for improving the security of `dir-staging`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`dir-staging` leverages GitHub's private vulnerability reporting.
